...
class AutologinPlugin {
  ...
  static Future<Credential?> getLoginData() async {
    final List<dynamic> data = await (_channel.invokeMethod('getLoginData') as FutureOr<List<dynamic>>);
  ...
  static Future<bool?> saveLoginData(Credential credential) async {
    return await _channel.invokeMethod(
        'saveLoginData', <String, dynamic>{'username': credential.username, 'password': credential.password});
  }
